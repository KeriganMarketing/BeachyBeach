...
if ($_POST['cmd'] == 'mlssearch') {
	$mls->setSession($_POST);
	$query = $mls->buildQuery($_POST);
} else {
	//print_r($_SESSION);
	$query = $mls->buildQuery($_SESSION);
}
    ...
    <div class="listing-tile col-md-6 col-lg-3 text-center">
        <div class="listing-tile-container">
            <a class="listing-link"
                    href="/listing/<?php echo $result->mls_account; ?>/"></a>
            ...
            <div class="tile-info">
                ...
                <div class="tile-section">
                    <span class="addr1"><?php echo $result->street_number . ' ' . $result->street_name; ?></span>
                ...
                <div class="tile-section">
                    <div class="row">
						<?php if ( $result->class == 'RES' || strpos( $result->class, 'Residential' ) !== false ) { //RESIDENTIAL LISTINGS ?>
                            ...
                            <div class="col text-xs-center">
                                <span class="icon"><img src="<?php echo $mls->getSvg( 'sqft' ); ?>"
                                            alt="sqft"
                                            class="img-fluid lazy"></span>
...
/**
 * Move this block where you want pagination to go
 */
