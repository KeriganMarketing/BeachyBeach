        ...
        <div class="search-bar">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="area-select form-control" name="city[]" id="id-area-select" multiple="multiple"></select>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="input-container">
                    <select class="prop-type-input form-control" name="class[]" multiple="multiple"></select>
                    </div>
                </div>
